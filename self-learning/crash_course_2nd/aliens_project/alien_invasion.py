...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        """
        The call to ship requires one argument, an instance of alieninvasion. The self argument here refers to the
        current instance of alieninvasion. This is the parameter that gives Ship access to the game's resources, such
        as the screen object
        """
    ...
    # Helper events are defined to simplify code
    # Helper events are defined with a leading underscore
    ...
    def _update_aliens(self):
        """
        Check if aliens are at an edge and then
    ...
    def _check_fleet_edges(self):
        """Respond appropriately ifany alienshave reached an edge"""
        for alien in self.aliens.sprites():
